...
export const malaybalayLatitudeSchema = z.coerce
  .number()
  .min(MALAYBALAY_BOUNDS.south, 'Location must be within Malaybalay City, Bukidnon')
  .max(MALAYBALAY_BOUNDS.north, 'Location must be within Malaybalay City, Bukidnon');

export const malaybalayLongitudeSchema = z.coerce
  .number()
  .min(MALAYBALAY_BOUNDS.west, 'Location must be within Malaybalay City, Bukidnon')
  .max(MALAYBALAY_BOUNDS.east, 'Location must be within Malaybalay City, Bukidnon');
...
export type UpdatePropertyLocationInput = z.infer<typeof updatePropertyLocationSchema>;
